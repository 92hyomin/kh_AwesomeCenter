...
public class TeacherVO {
	...
	String teacher_jubun;
	String teacher_postcode;
	String teacher_addr1;
	String teacher_addr2;
	String teacher_phone1;
	String teacher_phone2;
	String teacher_email;
	String teacher_photo;
	String teacher_registerday;
	String teacher_school;
	String teacher_major;
	String teacher_career1;
	String teacher_career2;
	String teacher_reason;
